...
const dotenvSchema = z.object({
  ...
  TURSO_AUTH_TOKEN: z.string({ required_error: 'Must provide a conection token' }).optional(),
  TURSO_DATABASE_URL: z.string({ invalid_type_error: 'Must provide a database url' }).optional(),
